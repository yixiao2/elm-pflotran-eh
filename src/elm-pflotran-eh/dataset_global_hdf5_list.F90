...
#include "petsc/finclude/petscvec.h"
  ...
  contains
    procedure, public :: Update => DatasetGlobalHd5ListUpdate
    procedure, public :: Strip => DatasetGlobalHd5ListStrip
  end type dataset_global_hdf5_list_type
...
function DatasetGlobalHd5ListCreate()
  ...
  class(dataset_global_hdf5_list_type), pointer :: DatasetGlobalHd5ListCreate
  
  class(dataset_global_hdf5_list_type), pointer :: data_mediator
...
subroutine DatasetGlobalHd5ListRead(data_mediator,input,option)
  ...
  class(dataset_global_hdf5_list_type) :: data_mediator
...
recursive subroutine DatasetGlobalHd5ListUpdate(this,data_mediator_vec,option)
  ...
  class(dataset_global_hdf5_list_type) :: this
